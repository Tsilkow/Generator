...
class Hex
{
	...
	int moisture = 0, int drainage = 0, std::vector<int> water = {},
    ...
    const Coords& getCoords() {return m_coords; }
	 
    const int& getType() {return m_type; }

    const int& getHeight() {return m_height; }

    const int& getTemperature() {return m_temperature; }

    const int& getMoisture() {return m_moisture; }
	 
    const int& getDrainage() {return m_drainage; }

    const std::vector<int>& getWater() {return m_water; }

    const int& getBuilding() {return m_building; }

    const int& getBorder(int border) {return m_borders[border]; }
};
